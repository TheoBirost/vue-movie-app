        ...
        <tbody>
          <tr v-for="category in categories" :key="category.id" class="border-b border-border hover:bg-white/5 transition-colors">
            ...
            <td class="p-4 text-right">
              <button @click="editCategory(category)" class="text-gold hover:text-[var(--color-ink)] text-xs font-bold uppercase tracking-wider transition-colors border border-gold/30 hover:bg-gold/10 px-3 py-1.5 rounded mr-2">
                Modifier
              </button>
