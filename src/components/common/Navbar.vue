    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex items-center justify-between h-24">
        <div class="flex items-center">
          <router-link to="/" class="flex-shrink-0 flex items-center gap-3" aria-label="Accueil Cinéaste">
        ...
        <div class="hidden md:flex items-center gap-4">
          <template v-if="props.loggedIn">
            ...
            <router-link to="/profile" class="nav-item" aria-label="Mon profil">
              <img
      ...
      <div v-if="isOpen" class="md:hidden border-t border-[#2A2D36]">
        ...
        <div class="pt-4 pb-3 border-t border-[#2A2D36]">
          <div class="flex items-center px-5">
            <template v-if="props.loggedIn">
              <router-link to="/profile" @click="isOpen = false" class="flex-shrink-0" aria-label="Mon profil">
